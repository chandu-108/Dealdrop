...
import AddProductForm from "@/components/ui/ui/AddProductForm";
    ...
    <main className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-17 max-w-2xl mx-auto">
        ...
        {user && products.length > 0 &&<section className="max-w-7xl mx-auto px-4 pb-20">
          <div className=" flex items-center justify-between mb-6">
           <h3 className="text-2xl fomt-bold text-gray-900">Your Tracked Products</h3>
